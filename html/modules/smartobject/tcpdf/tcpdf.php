...
// Johannes G・tert for JavaScript support.
		...
		*/
		public function Skew($angle_x, $angle_y, $x='', $y=''){
			...
			if($angle_x <= -90 OR $angle_x >= 90 OR $angle_y <= -90 OR $angle_y >= 90)
				$this->Error('Please use values between -90・ｽ and 90・ｽ for skewing');
			$x*=$this->k;
			$y=($this->h-$y)*$this->k;
			//calculate elements of transformation matrix
			$tm[0]=1;
...
// ---
		...
		*/
		protected function utf8Bidi($ta, $forcertl=false) {
			...
			// X10. The remaining rules are applied to each run of characters at the same level. For each run, determine the start-of-level-run (sor) and end-of-level-run (eor) type, either L or R. This depends on the higher of the two levels on either side of the boundary (at the start or end of the paragraph, the level of the 登ther・run is the base embedding level). If the higher level is odd, the type is R; otherwise, it is L.
		...
		* Adds a javascript
		* @access public
		* @author Johannes G・tert, Nicola Asuni
		* @since 2.1.002 (2008-02-12)
		*/
